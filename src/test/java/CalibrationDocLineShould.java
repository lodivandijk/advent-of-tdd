...
public class CalibrationDocLineShould {
   ...
   @Test
   public void should_determine_calibration_value_line1() {
      var calibrationDocLine = new CalibrationDocLine("1abc2");
      assertThat(calibrationDocLine.getCalibrationValue(), equalTo(12));
   }

   @Test
   public void should_determine_calibration_value_line2() {
      var calibrationDocLine = new CalibrationDocLine("pqr3stu8vwx");
      assertThat(calibrationDocLine.getCalibrationValue(), equalTo(38));
   }

      @Test
   public void should_determine_calibration_value_line3() {
      var calibrationDocLine = new CalibrationDocLine("a1b2c3d4e5f");
      assertThat(calibrationDocLine.getCalibrationValue(), equalTo(15));
   }

      @Test
   public void should_determine_calibration_value_line4() {
      var calibrationDocLine = new CalibrationDocLine("treb7uchet");
      assertThat(calibrationDocLine.getCalibrationValue(), equalTo(77));
   }
